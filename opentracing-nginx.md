...
- [nginx](https://nginx.org/en/download.html) v1.22
- [jaeger-all-in-on](https://www.jaegertracing.io/docs/1.35/getting-started/) v1.38
- [nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) v1.22
- [jaeger-client-cpp](https://github.com/jaegertracing/jaeger-client-cpp) v0.9 
...
因为这里使用了自己编译的gcc版本，需要指定下动态库的路径 <sup>refer 2</sup>
...
jaeger.json，参数的说明可以参考[configuration](https://github.com/jaegertracing/jaeger-client-cpp#configuration-via-environment)
...
对于 `nginx-opentracing` 更多的参数可以参考 [Reference.md](https://github.com/opentracing-contrib/nginx-opentracing/blob/master/doc/Reference.md)
...
更多的配置说明可以参考 [Tutorial.md](https://github.com/opentracing-contrib/nginx-opentracing/blob/master/doc/Tutorial.md)
...
>
> 2 [libstdc++.so.6: version GLIBCXX_3.4.20 not found](https://stackoverflow.com/questions/53592796/libstdc-so-6-version-glibcxx-3-4-20-not-found)
>
> 3 [nginx load_module](https://nginx.org/en/docs/ngx_core_module.html#load_module)
