...
![image-20221024235352996](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235352996.png)
...
![image-20221024235406831](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235406831.png)
...
![image-20221024235424248](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235424248.png)
...
![image-20221024235550927](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235550927.png)

整个空间按顺时针方向组织。0和2<sup>32</sup>-1在零点中方向重合。

下一步将各个服务器使用Hash进行一个哈希，具体可以选择服务器的ip或主机名作为关键字进行哈希，这样每台机器就能确定其在哈希环上的位置，这里假设将上文中四台服务器使用ip地址哈希后在环空间的位置如下：

![image-20221024235605237](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235605237.png)

接下来使用如下算法定位数据访问到相应服务器：将数据key使用相同的函数Hash计算出哈希值，并确定此数据在环上的位置，从此位置沿环顺时针“行走”，第一台遇到的服务器就是其应该定位到的服务器。

例如我们有Object A、Object B、Object C、Object D四个数据对象，经过哈希计算后，在环空间上的位置如下：

![image-20221024235630275](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235630275.png)
...
![image-20221024235642951](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235642951.png)
...
![image-20221024235702564](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235702564.png)
...
![image-20221024235718095](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235718095.png)
...
![image-20221024235759078](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235759078.png)



![image-20221024235812368](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235812368.png)
...
![image-20221024235829164](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235829164.png)

可看出6E-8E存在11211上，大于。35.7E-35.9E存在11212上

![image-20221024235847363](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235847363.png)



![image-20221024235855512](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235855512.png)
...
![image-20221024235917083](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235917083.png)
...
![image-20221024235932558](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235932558.png)

运行一段时间后，可见命中率保持20%左右，在预热完毕后，逐步上升。

![image-20221024235950143](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221024235950143.png)
...
![image-20221025000013472](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221025000013472.png)
...
![image-20221025000031883](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221025000031883.png)

观察一段时间后命中率逐步上升到95%

![image-20221025000050675](https://cdn.jsdelivr.net/gh/CylonChau/imgbed/img/image-20221025000050675.png)
