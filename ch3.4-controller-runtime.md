# Kubernetes controller组件的核心 - controller-runtime
...
![image-20220625221632675](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220625221632675.png)

<center>图：controller-runtime structure</center>

![image-20220625221548958](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220625221548958.png)
...
![image-20220626231657599](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220626231657599.png)
...
通过注释，我们可以看到 [For()](https://github.com/kubernetes-sigs/controller-runtime/blob/ffd9ec8768b7d2e82aee6b0c76d481a5bdda4075/pkg/builder/controller.go#L82-L94) 提供了 调解对象类型，ControllerManagedBy 通过  *reconciling object* 来相应对应`create/delete/update` 事件。调用 `For()` 相当于调用了 `Watches(&source.Kind{Type: apiType}, &handler.EnqueueRequestForObject{})` 。
...
![svg](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/controller-runtime.svg)
