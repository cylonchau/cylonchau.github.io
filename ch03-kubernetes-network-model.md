...
本文将深入探讨Kubernetes中的网络模型，以及对各种网络模型进行分析。
...
![典型的底层网络](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/download.png)
...
![image-20220820230021593](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220820230021593.png)

<center>图：underlay network topology in kubernetes</center><br>

这种模型下典型的有 *flannel* 的 *host-gw* 模式与 *calico* *BGP* 模式。

#### flannel host-gw <sup><a href="#1">[1]</a></sup>

*flannel host-gw* 模式中每个Node需要在同一个二层网络中，并将Node作为一个路由器，跨节点通讯将通过路由表方式进行，这样方式下将网络模拟成一个*underlay network*。

![网络交换机图 1](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/SwitchDiagram1_update_feb16.jpeg)
...
#### Calico BGP <sup><a href="#2">[2]</a></sup>

BGP（*Border Gateway Protocol*）是去中心化自治路由协议。它是通过维护IP路由表或'前缀'表来实现AS （*Autonomous System*）之间的可访问性，属于向量路由协议。

![img](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/ti020109.gif)
...
![相关图片、图表或屏幕截图](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/cisco-nx-os-calico-network-design_0.jpeg)
...
#### IPVLAN & MACVLAN <sup><a href="#4">[4]</a></sup>
...
![img](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/7a021d86-virtual-networking-1024x380.png)
...
*multus* 是 intel 开源的CNI方案，是由传统的 *cni* 与 *multus*，并且提供了 SR-IOV CNI 插件使 K8s pod 能够连接到 SR-IOV VF 。这是使用了 *IPVLAN/MACVLAN* 的功能。
...
![image-20220817154334081](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220817154334081.png)
...
![布鲁吉](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/multus02.png)
...
![图 4：建立在 Internet 样式底层之上的示例 Overlay 网络](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/Example-Overlay-Network-built-on-top-of-an-Internet-style-Underlay.png)
...
![img](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/IPIP_Process.png)
...
![image-20220817163743182](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220817163743182.png)

<center>图：IPIP in kubernetes</center><br>

![image-20220817163814698](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220817163814698.png)
...
![image-20220815232351298](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220815232351298.png)
...
![image-20220816161418748](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220816161418748.png)

<center>图：VxLAN in kubernetes</center><br>

![image-20220816164301428](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/image-20220816164301428.png)
...
### weave vxlan <sup><a href="#3">[3]</a></sup>

weave也是使用了 *VxLAN* 技术完成的包的封装，这个技术在 *weave* 中称之为 *fastdp (fast data path)*，与 *calico* 和 *flannel* 中用到的技术不同的，这里使用的是 Linux 内核中的 *openvswitch datapath module*。与其他的 *VxLAN* 模型不同的是，weave对网络流量进行了加密。

![Weave Net Encapsulation](https://raw.githubusercontent.com/CylonChau/imgbed/main/img/weave-net-fdp1-1024x454.png)
...
>**Reference**
>
><sup id="1">[1]</sup> [flannel host-gw](https://github.com/flannel-io/flannel/blob/master/Documentation/backends.md#host-gw)
>
><sup id="2">[2]</sup> [calico bgp networking](https://projectcalico.docs.tigera.io/networking/bgp)
>
><sup id="3">[3]</sup> [calico bgp networking](https://www.weave.works/docs/net/latest/concepts/router-encapsulation/)
>
><sup id="4">[4]</sup> [sriov network](https://github.com/k8snetworkplumbingwg/sriov-network-device-plugin)
>
><sup id="4">[5]</sup> [danm](https://github.com/nokia/danm)
